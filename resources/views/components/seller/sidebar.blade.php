        ...
        <div>
            ...
            <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
                <ul id="sidebarnav">
                    ...
                    <x-admin.sidebar-link href="{{ route('seller.konsultasi') }}" :active="request()->is('seller.konsultasi')" icon="solar:armchair-2-bold-duotone">Konsultasi</x-admin.sidebar-link>
                    ...
                    <x-admin.sidebar-link href="{{ route('seller.pdf') }}" :active="request()->is('seller.pdf')" icon="solar:file-download-bold-duotone">Download</x-admin.sidebar-link>
                </ul>
            </nav>
