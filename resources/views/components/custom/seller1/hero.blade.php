...
<section id="home" class="hero section">
  <div class="hero-bg">
    <img src="custom1/img/hero-bg-light.webp" alt="">
  </div>
  <div class="container text-center">
    <div class="d-flex flex-column justify-content-center align-items-center">
      ...
      <img src="{{ asset('/custom1/img/hero-services-img.webp  ') }}" class="img-fluid hero-img" alt="" data-aos="zoom-out" data-aos-delay="300">
    </div>
  </div>
